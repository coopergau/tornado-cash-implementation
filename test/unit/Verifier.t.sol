...
contract VerifierTest is Test {
    ...
    function testValidProofReturnsTrue() public view {
        ...
        // Act
        bool validProof = verifier.verifyProof(valid_a, valid_b, valid_c, pubInputs);
    ...
    function testWrongA0ReturnsFalseProof() public view {
        // Arrange
        uint256[3] memory pubInputs = [validRoot, validNullHash, validUserAddress];
        uint256[2] memory wrong_a = [valid_a[0] + 1, valid_a[1]];

        // Act
        bool validProof = verifier.verifyProof(wrong_a, valid_b, valid_c, pubInputs);
    ...
    function testWrongA1ReturnsFalseProof() public view {
        // Arrange
        uint256[3] memory pubInputs = [validRoot, validNullHash, validUserAddress];
        uint256[2] memory wrong_a = [valid_a[0], valid_a[1] + 1];
    ...
    function testWrongB00ReturnsFalseProof() public view {
        // Arrange
        uint256[3] memory pubInputs = [validRoot, validNullHash, validUserAddress];
        uint256[2][2] memory wrong_b = [[valid_b[0][0] + 1, valid_b[0][1]], [valid_b[1][0], valid_b[1][1]]];

        // Act
        bool validProof = verifier.verifyProof(valid_a, wrong_b, valid_c, pubInputs);
    ...
    function testWrongB01ReturnsFalseProof() public view {
        // Arrange
        uint256[3] memory pubInputs = [validRoot, validNullHash, validUserAddress];
        uint256[2][2] memory wrong_b = [[valid_b[0][0], valid_b[0][1] + 1], [valid_b[1][0], valid_b[1][1]]];
    ...
    function testWrongB10ReturnsFalseProof() public view {
        // Arrange
        uint256[3] memory pubInputs = [validRoot, validNullHash, validUserAddress];
        uint256[2][2] memory wrong_b = [[valid_b[0][0], valid_b[0][1]], [valid_b[1][0] + 1, valid_b[1][1]]];
    ...
    function testWrongB11ReturnsFalseProof() public view {
        // Arrange
        uint256[3] memory pubInputs = [validRoot, validNullHash, validUserAddress];
        uint256[2][2] memory wrong_b = [[valid_b[0][0], valid_b[0][1]], [valid_b[1][0], valid_b[1][1] + 1]];
    ...
    function testWrongC0ReturnsFalseProof() public view {
        // Arrange
        uint256[3] memory pubInputs = [validRoot, validNullHash, validUserAddress];
        uint256[2] memory wrong_c = [valid_c[0] + 1, valid_c[1]];

        // Act
        bool validProof = verifier.verifyProof(valid_a, valid_b, wrong_c, pubInputs);
    ...
    function testWrongC1ReturnsFalseProof() public view {
        // Arrange
        uint256[3] memory pubInputs = [validRoot, validNullHash, validUserAddress];
        uint256[2] memory wrong_c = [valid_c[0], valid_c[1] + 1];
